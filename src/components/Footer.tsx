          ...
          <div>
            ...
            <div className="flex space-x-4">
              <motion.a
                ...
                className="w-10 h-10  border border-gold-deep/50 flex items-center justify-center text-gold-deep hover:border-gold-light hover:text-gold-light transition-colors"
              >
